...
🔗 [LinkedIn](https://www.linkedin.com/in/renanlememenezes) 🔗 [Portfólio](https://www.rnmenzs.com.br)
---
...
- [devrnmenzs](https://github.com/rnmenzs/devrnmenzs) — portfólio/CV online com interface de sessão de terminal · Next.js 16 · TypeScript · Tailwind v4 · [rnmenzs.com.br](https://www.rnmenzs.com.br)
- [dio-deteccao-anomalias-transacoes](https://github.com/rnmenzs/dio-deteccao-anomalias-transacoes) — detecção de anomalias em transações financeiras com Python: balanceamento de classes, XGBoost, Isolation Forest e explicabilidade SHAP
- [AR_interior_design](https://github.com/rnmenzs/AR_interior_design) — app de Realidade Aumentada em Unity/C# para visualizar móveis e decoração sobre o ambiente real
...
Cybersecurity — Fundamentos de Pentest · Fundamentos de Cibersegurança · Princípios da Cibersegurança · Cibersegurança Essencial: Bases para Projetos com Dados e IA (8h) · Introdução ao DevSecOps · Introdução à Cibersegurança (Santander/DIO)
